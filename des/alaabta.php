                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                           ...
                                           <div class="alert alert-success d-none"  role="alert">
                                               ...
                                               <div class="col-sm-12">
                                               <div class="form-group">
                                                <label for="exampleFormControlInput1" class="form-label ">lacagta</label>
                                                <input type="text" name="lacagta" id="lacagta" class='form-control mt-2' required>
                                                </div>
                                               </div>
...
include 'footer.php';
?>
<script src="../js/alaabta.js"></script>